...
def adult_workclass(x):
    workclass1 = {'Private': 0, 'Self-emp-not-inc': 1, 'Self-emp-inc': 2, 'Federal-gov': 3, 'Local-gov': 4,
...
if __name__ == '__main__':
    train_file = 'D:/pytest/lxy/adult.data'
    test_file = 'D:/pytest/lxy/adult.test'

    train_deal_file = 'D:/pytest/lxy/adult_deal.data'
    test_deal_file = 'D:/pytest/lxy/adult_deal.test'
    ...
    # trans to value
    transToValues(train_deal_file,'D:/pytest/lxy/adult_deal_value.data',remove_duplicates=False,remove_unKnowValue=False)
    transToValues(test_deal_file,'D:/pytest/lxy/adult_deal_value.test',remove_duplicates=False,remove_unKnowValue=False)
